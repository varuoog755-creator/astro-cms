...
print(f"Loaded {len(items)} fetched product objects from BrowserOS Neo output")
...
for idx, item in enumerate(items):
    ...
    if not clean_desc or len(clean_desc) < 20:
        clean_desc = f"Transform your home with Teepul {name}. Crafted from premium high-density polyester with rust-proof silver eyelets, light filtering, and thermal heat reduction."
    ...
    formatted_products.append({
        ...
        "currency": "₹",
        "category": cat,
        "badge": "Meesho Top Choice" if idx < 2 else ("Best Seller" if idx < 5 else "Luxury Pick"),
        ...
        "features": [
            ...
            "Thermal Insulation & Heat Shield",
            "Wrinkle Resistant Soft Washable Fabric"
        ]
    })
...
print(f"Generated {len(formatted_products)} products in scratch/formatted_seller_catalog.json")
